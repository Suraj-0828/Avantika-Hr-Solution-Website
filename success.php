...
<head>
   ...
   <!-- Title and Discription start -->
	...
	<meta name="description"
		content="Thank you for reaching out! Your form has been submitted successfully. Our team will get back to you shortly.">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/breadcrumbs/febicon.png">
...
<body class="defult-home">
    ...
    <div class="main-content">
        ...
        <div class="rs-breadcrumbs img1">
            <div class="container">
                <div class="breadcrumbs-inner">
                    <h1 class="page-title">
                 Success
                        <span id="global-publicity" class="watermark">Success</span>
                    </h1>
                    <span class="sub-text">Your submission was successful! We’ll connect with you soon.</span>
                </div>
            </div>
        </div>
        <!-- Breadcrumbs End -->
        ...
        <div class="container pt-5 pb-4">
            <div class="img-size">
                <img class="imgg" src="assets/images/breadcrumbs/success.png" />
            </div>
